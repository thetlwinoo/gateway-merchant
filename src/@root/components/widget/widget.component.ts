...
export class RootWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(RootWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<RootWidgetToggleDirective>;
