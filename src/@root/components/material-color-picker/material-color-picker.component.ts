...
import { MatColors } from '@root/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const ROOT_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => RootMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'root-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : rootAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [ROOT_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class RootMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, root-navy-700 etc.)
