...
import '@root/components/highlight/prism-languages';

@Component({
    selector : 'root-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class RootHighlightComponent implements OnInit, OnDestroy
{
    // Source
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using root-highlight
        // component
