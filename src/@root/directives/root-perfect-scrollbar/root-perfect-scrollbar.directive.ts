...
import { RootPerfectScrollbarGeometry, RootPerfectScrollbarPosition } from '@root/directives/root-perfect-scrollbar/root-perfect-scrollbar.interfaces';
import { RootConfigService } from '@root/services/config.service';

@Directive({
    selector: '[rootPerfectScrollbar]'
})
export class RootPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): RootPerfectScrollbarGeometry
    {
        return new RootPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): RootPerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new RootPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
